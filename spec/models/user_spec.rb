...
RSpec.describe User, type: :model do
  describe "ユーザー新規登録" do
    ...
    it "名前(名字)が空だと登録できない" do
      user = User.new(nickname: "abe", email: "kkk@gmail.com", password: "00000000", password_confirmation: "0000000", firstname: "")
      user.valid?
      expect(user.errors.full_messages).to include("Firstname can't be blank")
    end
    it "名前が空だと登録できない" do
      user = User.new(nickname: "abe", email: "kkk@gmail.com", password: "00000000", password_confirmation: "0000000", firstname: "a", lastname: "")
      user.valid?
      expect(user.errors.full_messages).to include("Lastname can't be blank")
    end
    it "名前(名字、カナ)が空だと登録できない" do
      user = User.new(nickname: "abe", email: "kkk@gmail.com", password: "00000000", password_confirmation: "0000000", firstname: "a", lastname: "b", firstnamekana: "")
      user.valid?
      expect(user.errors.full_messages).to include("Firstnamekana can't be blank")
    end
    it "名前(カナ)が空だと登録できない" do
      user = User.new(nickname: "abe", email: "kkk@gmail.com", password: "00000000", password_confirmation: "0000000", firstname: "a", lastname: "b", firstnamekana: "ab", lastnamekana: "")
      user.valid?
